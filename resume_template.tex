...
\begin{twocolentry}{May 2024 -- Present}
    \textbf{ {{- role_albertsons -}} }, Albertsons -- Dallas, TX
\end{twocolentry}
\begin{onecolentry}
{% if experience_albertsons %}
\begin{highlights}
    {% for bullet in experience_albertsons %}
    \item {{ bullet }}
    {% endfor %}
\end{highlights}
{% endif %}
...
\begin{twocolentry}{May 2020 -- July 2023}
    \textbf{ {{- role_valuelabs -}} }, ValueLabs -- Hyderabad
\end{twocolentry}
\begin{onecolentry}
{% if experience_valuelabs %}
\begin{highlights}
    {% for bullet in experience_valuelabs %}
    \item {{ bullet }}
    {% endfor %}
\end{highlights}
{% endif %}
...
\begin{twocolentry}{ {{- project.duration -}} }
    \textbf{ {{- project.name -}} }
\end{twocolentry}
\begin{onecolentry}
{% if project.bullets %}
...
\item {{ category.name }}: {{ category.keywords }}
{% endfor %}
\end{itemize}
{% endif %}
\end{minipage}
...
\begin{highlights}
    ...
    \item \textbf{Relevant Coursework:} {{ coursework }}
\end{highlights}
\end{onecolentry}
